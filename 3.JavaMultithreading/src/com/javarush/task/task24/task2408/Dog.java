...
public class Dog implements Pet {
    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable{
            ...
            public String say() {
                if (i<1){
                    return super.getSuperQuotes() + getName()+ super.getSuperQuotes() + " спит.";
                } else {
                    ...
                    Date d = new Date();
                    return super.getSuperQuotes() + getName()+ super.getSuperQuotes() + " лает г" + sb.toString() + "в! " + formatter.format(d);
                }
            }
            private String getName() {
                return name;//добавить ****
            }
        }
        return new DogPet();
    }
